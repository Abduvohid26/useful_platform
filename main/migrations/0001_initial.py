    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(upload_to='welcome-images', validators=[main.utils.validate_image])),
                ('author', models.CharField(max_length=255)),
                ('author_image', models.FileField(upload_to='auhtor-images', validators=[main.utils.validate_image])),
            ],
        ),
        migrations.CreateModel(
            name='Directions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.problems')),
            ],
        ),
        migrations.CreateModel(
            name='Sciences',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('body', models.TextField()),
                ('directions', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.directions')),
